...
describe ('OrderBook testing', ()=>{
	...
	before(async()=>{
		...
		server1 = new ExchangeServer(port1, 'http://127.0.0.1:30001');
		const port2 = 1024 + Math.floor(Math.random() * 1000);
		server2 = new ExchangeServer(port2, 'http://127.0.0.1:40001');
		client1 = new ExchangeClient('http://127.0.0.1:30001');
		client2 = new ExchangeClient('http://127.0.0.1:40001');
